...
function createParticleFlow(sourceBottle: any, targetBottle: any) {
  ...
  particleSystem.emitter = new BABYLON.Vector3(1, 2, -2)
  // sourceBottle.absolutePosition
  ...
  particleSystem.direction1 = new BABYLON.Vector3(1, 2, -2)
  particleSystem.direction2 = new BABYLON.Vector3(1, 0, -2)
  // 物理行为
