...
function createParticleFlow(sourceBottle: any, targetBottle: any) {
  particleSystem = new BABYLON.ParticleSystem('water', 10, scene)
  //  particleSystem.emitRate = 100;
  //  particleSystem.minLifeTime = 2;
  //  particleSystem.manualEmitCount = 40000;
  // 配置粒子
  particleSystem.particleTexture = new BABYLON.Texture('/textures/water.png', scene)
  particleSystem.emitter = sourceBottle.position.add(new BABYLON.Vector3(0, 0.5, 0))
