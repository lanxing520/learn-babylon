...
var createWaterStream = function (position) {
  var particleSystem1 = new BABYLON.ParticleSystem('waterStream', 2000, scene)

  // 发射器设置

  // particleSystem.particleEmitterType = new BABYLON.PointEmitter()
  particleSystem.emitter = particleSystem1.createPointEmitter(
