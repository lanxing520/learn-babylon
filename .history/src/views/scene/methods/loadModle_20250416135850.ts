...
export async function loadItems() {
  ...
  try {
    ...
    moveRotateSaltWater.normalize(0, 8 * frameRate)

    moveRotateSaltWater.onAnimationGroupLoopObservable.add((group) => {
      console.log('即将开始新的动画循环')
      // 可以在这里检查当前播放状态
      console.log(group.isPlaying)
    })
