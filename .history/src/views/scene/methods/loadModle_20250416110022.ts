...
import {createAnimeGroup, pourAnimation, addWaterAni, moveAni, rotateAni, customRotate } from './animation'
   ...
   const moveRotateSaltWater = createAnimeGroup('moveRotateSaltWater', [
     {
       animation: moveAni('position', [
         {
           frame: 0,
           value: new BABYLON.Vector3(op.x, op.y, op.z),
         },
         {
           frame: 0,
           value: new BABYLON.Vector3(op.x, op.y + 0.4, op.z),
         }[(op.x, op.y, op.z)],
         [],
       ]),
