...
const cup = BABYLON.MeshBuilder.CreateCylinder("cup", {
    height: 3,
    diameterTop: 1.5,    // 杯口直径
    diameterBottom: 1.5,    // 杯底直径
    tessellation: 32,     // 圆滑度（面数）
    enclose: false,      // false = 不封闭两端（空心）
}, scene);
...
glassMaterial.emissiveColor = new BABYLON.Color3(0.2, 0.2, 0.2);
cup.material = glassMaterial;
